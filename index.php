...
<head>
    ...
    <title><?= $_settings->info('name') ?></title>
            ...
            <?php if($page == "home" || $page == "about_us"): ?>
                <div id="header" class="shadow mb-4">
                    <div class="d-flex justify-content-center h-100 w-100 align-items-center flex-column">
                        <h1 class="w-100 text-center"><?= $_settings->info('name') ?></h1>
                        <a href="./?page=appointment" class="btn btn-lg btn-light rounded-3" id="book_appointment">Book an Appointment</a>
                    </div>
                </div>
            <?php endif; ?>

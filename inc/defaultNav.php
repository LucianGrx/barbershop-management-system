...
<nav class="main-header navbar navbar-expand-md navbar-light bg-white shadow-sm">
    <div class="container">
        <a href="<?php echo base_url ?>index3.html" class="navbar-brand d-flex align-items-center">
            <img src="<?php echo base_url ?>dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-bold ml-2">AdminLTE 3</span>
        </a>
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    <span class="dropdown-header">3 New Messages</span>
...
<style>
    /* Stiluri suplimentare pentru navbar */
    .main-header {
        background-color: #f8f9fa; /* Fundal alb pentru navbar */
    }
    .nav-link {
        color: #333; /* Culoare text pentru link-uri */
    ...
    .navbar-nav .nav-item.dropdown:hover .dropdown-menu {
        display: block; /* Afișează meniul dropdown la hover */
    }
